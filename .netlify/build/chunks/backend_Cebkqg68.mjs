...
async function getActivitesAndFilmsById(id) {
    try {
...
async function allFilmsFiltre(jour, genre) {  
...
export { getInvite as a, addMessage as b, getFilm as c, allFilms as d, getActivitesAndFilmsById as e, allInvites as f, getActivite as g, allFilmsFiltre as h, allActivites as i, formatDate as j };
